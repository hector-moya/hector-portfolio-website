...
<div class="relative overflow-hidden bg-linear-to-br from-teal-950 via-zinc-900 to-green-950">
    {{-- Decorative glow --}}
    <div class="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
        <div class="absolute left-1/2 top-1/2 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full bg-teal-500/20 blur-3xl"></div>
    </div>
    ...
    <div class="relative mx-auto max-w-4xl px-6 py-20 text-center sm:py-28 lg:px-8">
        ...
        @if (!empty($data['content']))
            <div data-animate data-delay="100">
                <flux:text class="mx-auto mt-6 max-w-2xl text-lg leading-8 text-teal-100/80">
