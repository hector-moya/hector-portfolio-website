<div class="space-y-6">
    <flux:heading size="lg">{{ __('Card Grid Settings') }}</flux:heading>

    <flux:select label="{{ __('Columns') }}" wire:model="form.config.columns">
    ...
    <flux:input
        type="number"
        label="{{ __('Max Cards') }}"
        wire:model.blur="form.config.max_items"
