...
<div class="space-y-2">
    ...
    @if ($asset)
        <div class="group relative aspect-video w-48 overflow-hidden rounded-lg border-2 border-gray-200 dark:border-gray-700">
            ...
            <button type="button" wire:click="form.fieldValues.{{ $field->handle }} = null" class="absolute right-2 top-2 rounded-full bg-white p-1 opacity-0 shadow transition-opacity group-hover:opacity-100 dark:bg-gray-800">
